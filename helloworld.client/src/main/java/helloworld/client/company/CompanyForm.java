...
import helloworld.client.company.CompanyForm.MainBox.CancelButton;
import helloworld.client.company.CompanyForm.MainBox.CompanyRatingField;
import helloworld.client.company.CompanyForm.MainBox.CompanyTypeGroup;
import helloworld.client.company.CompanyForm.MainBox.NameField;
import helloworld.client.company.CompanyForm.MainBox.OkButton;
import helloworld.client.company.CompanyForm.MainBox.ShortNameField;
import helloworld.shared.company.CompanyFormData;
import helloworld.shared.company.CompanyRatingCodeType;
import helloworld.shared.company.CompanyTypeCodeType;
import helloworld.shared.company.ICompanyService;
import helloworld.shared.company.UpdateCompanyPermission;
